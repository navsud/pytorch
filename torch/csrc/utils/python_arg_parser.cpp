...
auto FunctionParameter::_check(
  ...
  switch (type_) {
    ...
    case ParameterType::INT64: {
      ...
      if (torch::is_symint(py::handle(obj)) || torch::is_dynint(py::handle(obj))) {
        // This will induce a guard
        return true;
      }
      return false;
    ...
    case ParameterType::DEVICE:
      ...
      return THPUtils_checkLong(obj) || THPUtils_checkString(obj) ||
          THPDevice_Check(obj) || torch::is_symint(py::handle(obj)) || torch::is_dynint(py::handle(obj));
...
at::Tensor PythonArgs::tensor_slow(int i) {
  ...
  } else if (torch::is_symint(py::handle(obj)) || torch::is_dynint(py::handle(obj))) {
    save_symint = true;
